...
| | keyboard | gamepad |
|---|---|---|
| open / close the quest log | `F2` (also `Escape` to close) | R3, right stick click |
...
R3 was left unused by the entry-mode removal and is reclaimed here. Select
still belongs to the F1 key page and is not displaced. All bindings are by
